...
if(isset($_SESSION['id_user'])){
	...
	//koneksi terpusat
	   ...
	   $_mysqli = new mysqli("localhost","thanos_tour","thanos_tour","thanos_tour");
        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
					...
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">Yogya Tourism</span><br />
