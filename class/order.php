...
class order extends database{
	...
	function __construct()
		...
		public function input($id_user,$id_paket,$tgl_tour){
			$db = new database();
			$sql = "INSERT INTO `tbl_pesan`( `id_user`, `id_paket`, `id_hotel`, `tgl_pesan`, `tgl_tour`)values('$id_user','$id_paket',NOW(),'$tgl_tour')";
